...
class CO2Transport_Oeuvray:
    ...
    def __init__(self):
        ...
        # CO2RouteX keeps the two source workbooks beside this module so the
        # cost model is portable and does not depend on an Adopt-Net0 install.
        input_path = Path(__file__).resolve().parent / "data"
        ...
        # The supplied Oeuvray input data are used on their 2021 EUR basis.
        self.financial_year_in = 2021
...
class CO2Chain_Oeuvray(CO2Transport_Oeuvray):
    ...
    def calculate_cost(self, options):
        ...
        self.p_initial_mpa = options["p_inlet_bar"] / 10
...
class CO2Compression_Oeuvray(CO2Transport_Oeuvray):
    ...
    def calculate_cost(self, options):
        ...
        self.p_outlet_mpa = options["p_outlet_bar"] / 10
        self.discount_rate = options["discount_rate"]
        self.terrain = options["terrain"]
